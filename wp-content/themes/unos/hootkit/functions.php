...
function unos_register_hootkit( $config ) {
	...
	$config = array(
		...
		'supports'  => array( 'cta-styles', 'content-blocks-style5', 'content-blocks-style6', 'slider-styles', 'post-grid-firstpost-slider' ),
	);
	return $config;
}
endif;
...
function unos_localize_hootkit() {
	...
	$scriptdata['contentblockhovertext'] = 'disable'; // Needed for proper positioning of animation in latest themes

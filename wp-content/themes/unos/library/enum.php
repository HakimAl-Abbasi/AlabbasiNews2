...
function hoot_enum_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'unos' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'unos' ),
		'repeat-y'  => __( 'Repeat Vertically', 'unos' ),
		'repeat'    => __( 'Repeat All', 'unos' ),
		);
...
function hoot_enum_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'unos' ),
		'top center'    => __( 'Top Center', 'unos' ),
		'top right'     => __( 'Top Right', 'unos' ),
		'center left'   => __( 'Middle Left', 'unos' ),
		'center center' => __( 'Middle Center', 'unos' ),
		'center right'  => __( 'Middle Right', 'unos' ),
		'bottom left'   => __( 'Bottom Left', 'unos' ),
		'bottom center' => __( 'Bottom Center', 'unos' ),
		'bottom right'  => __( 'Bottom Right', 'unos')
		);
...
function hoot_enum_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'unos' ),
		'fixed'  => __( 'Fixed in Place', 'unos'),
		);
...
function hoot_enum_background_size() {
	$default = array(
		'original' => __( 'Original Size', 'unos' ),
		'contain'  => __( 'Fit to Screen', 'unos'),
		'cover'    => __( 'Fill Screen', 'unos'),
		);
...
function hoot_enum_background_type() {
	$default = array(
		'predefined' => __( 'Predefined Pattern', 'unos' ),
		'custom'     => __( 'Custom Image', 'unos' ),
		);
...
function hoot_enum_font_styles() {
	$default = array(
		'none'                      => __( 'None', 'unos' ),
		'italic'                    => __( 'Italic', 'unos' ),
		'bold'                      => __( 'Bold', 'unos' ),
		'bold italic'               => __( 'Bold Italic', 'unos' ),
		'semibold'                  => __( 'SemiBold', 'unos' ),
		'semibold italic'           => __( 'SemiBold Italic', 'unos' ),
		'lighter'                   => __( 'Light', 'unos' ),
		'lighter italic'            => __( 'Light Italic', 'unos' ),
		'uppercase'                 => __( 'Uppercase', 'unos' ),
		'uppercase italic'          => __( 'Uppercase Italic', 'unos' ),
		'uppercase bold'            => __( 'Uppercase Bold', 'unos' ),
		'uppercase bold italic'     => __( 'Uppercase Bold Italic', 'unos' ),
		'uppercase semibold'        => __( 'Uppercase SemiBold', 'unos' ),
		'uppercase semibold italic' => __( 'Uppercase SemiBold Italic', 'unos' ),
		'uppercase lighter'         => __( 'Uppercase Light', 'unos' ),
		'uppercase lighter italic'  => __( 'Uppercase Light Italic', 'unos' )
		);
...
function hoot_enum_social_profiles( $skype = false, $email = true ) {
	$social = array(
		'fa-amazon'         => __( 'Amazon', 'unos' ),
		'fa-android'        => __( 'Android', 'unos' ),
		'fa-apple'          => __( 'Apple', 'unos' ),
		'fa-bandcamp'       => __( 'Bandcamp', 'unos' ),
		'fa-behance'        => __( 'Behance', 'unos' ),
		'fa-bitbucket'      => __( 'Bitbucket', 'unos' ),
		'fa-btc'            => __( 'BTC', 'unos' ),
		'fa-buysellads'     => __( 'BuySellAds', 'unos' ),
		'fa-codepen'        => __( 'Codepen', 'unos' ),
		'fa-codiepie'       => __( 'Codie Pie', 'unos' ),
		'fa-contao'         => __( 'Contao', 'unos' ),
		'fa-dashcube'       => __( 'Dash Cube', 'unos' ),
		'fa-delicious'      => __( 'Delicious', 'unos' ),
		'fa-deviantart'     => __( 'Deviantart', 'unos' ),
		'fa-digg'           => __( 'Digg', 'unos' ),
		'fa-dribbble'       => __( 'Dribbble', 'unos' ),
		'fa-dropbox'        => __( 'Dropbox', 'unos' ),
		'fa-eercast'        => __( 'Eercast', 'unos' ),
		'fa-envelope'       => __( 'Email', 'unos' ),
		'fa-etsy'           => __( 'Etsy', 'unos' ),
		'fa-facebook'       => __( 'Facebook', 'unos' ),
		'fa-flickr'         => __( 'Flickr', 'unos' ),
		'fa-forumbee'       => __( 'Forumbee', 'unos' ),
		'fa-foursquare'     => __( 'Foursquare', 'unos' ),
		'fa-free-code-camp' => __( 'Free Code Camp', 'unos' ),
		'fa-get-pocket'     => __( 'Pocket (getpocket)', 'unos' ),
		'fa-github'         => __( 'Github', 'unos' ),
		'fa-google'         => __( 'Google', 'unos' ),
		'fa-google-plus'    => __( 'Google Plus', 'unos' ),
		'fa-google-wallet'  => __( 'Google Wallet', 'unos' ),
		'fa-houzz'          => __( 'Houzz', 'unos' ),
		'fa-imdb'           => __( 'IMDB', 'unos' ),
		'fa-instagram'      => __( 'Instagram', 'unos' ),
		'fa-jsfiddle'       => __( 'JS Fiddle', 'unos' ),
		'fa-lastfm'         => __( 'Last FM', 'unos' ),
		'fa-leanpub'        => __( 'Leanpub', 'unos' ),
		'fa-linkedin'       => __( 'Linkedin', 'unos' ),
		'fa-meetup'         => __( 'Meetup', 'unos' ),
		'fa-mixcloud'       => __( 'Mixcloud', 'unos' ),
		'fa-paypal'         => __( 'Paypal', 'unos' ),
		'fa-pinterest'      => __( 'Pinterest', 'unos' ),
		'fa-quora'          => __( 'Quora', 'unos' ),
		'fa-reddit'         => __( 'Reddit', 'unos' ),
		'fa-rss'            => __( 'RSS', 'unos' ),
		'fa-scribd'         => __( 'Scribd', 'unos' ),
		'fa-skype'          => __( 'Skype', 'unos' ),
		'fa-slack'          => __( 'Slack', 'unos' ),
		'fa-slideshare'     => __( 'Slideshare', 'unos' ),
		'fa-snapchat'       => __( 'Snapchat', 'unos' ),
		'fa-soundcloud'     => __( 'Soundcloud', 'unos' ),
		'fa-spotify'        => __( 'Spotify', 'unos' ),
		'fa-stack-exchange' => __( 'Stack Exchange', 'unos' ),
		'fa-stack-overflow' => __( 'Stack Overflow', 'unos' ),
		'fa-steam'          => __( 'Steam', 'unos' ),
		'fa-stumbleupon'    => __( 'Stumbleupon', 'unos' ),
		'fa-trello'         => __( 'Trello', 'unos' ),
		'fa-tripadvisor'    => __( 'Trip Advisor', 'unos' ),
		'fa-tumblr'         => __( 'Tumblr', 'unos' ),
		'fa-twitch'         => __( 'Twitch', 'unos' ),
		'fa-twitter'        => __( 'Twitter', 'unos' ),
		'fa-viadeo'         => __( 'Viadeo', 'unos' ),
		'fa-vimeo-square'   => __( 'Vimeo', 'unos' ),
		'fa-vk'             => __( 'VK', 'unos' ),
		'fa-wikipedia-w'    => __( 'Wikipedia', 'unos' ),
		'fa-windows'        => __( 'Windows', 'unos' ),
		'fa-wordpress'      => __( 'WordPress', 'unos' ),
		'fa-xing'           => __( 'Xing', 'unos' ),
		'fa-y-combinator'   => __( 'Y Combinator', 'unos' ),
		'fa-yelp'           => __( 'Yelp', 'unos' ),
		'fa-youtube'        => __( 'Youtube', 'unos' ),
	);
...
function hoot_fonticons_list( $return = 'icons' ) {
	...
	if ( 'sections' == $return ) :
		return apply_filters( 'hoot_fonticons_sections', array(
			'fonticons' => __('Font Icons', 'unos'),
			'brands'    => __('Brands', 'unos'),
			)
		);
	endif;

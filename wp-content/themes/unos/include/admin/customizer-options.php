...
function unos_customize_dynamic_cssrules() {
	...
	if ( is_customize_preview() ) {
		...
		$settings['accent_color'] = array(
			'color'			=> array( 'body.wordpress input[type="submit"]:hover, body.wordpress #submit:hover, body.wordpress .button:hover, body.wordpress input[type="submit"]:focus, body.wordpress #submit:focus, body.wordpress .button:focus',
		...
		if ( !$hootpload ) {
			...
			array_push( $settings['accent_color']['color'], 'a:hover' ); // brevity : replaced by newvaldark in js
		} else {
		...
		$settings['accent_font'] = array(
			...
			'background'	=> array( 'body.wordpress input[type="submit"]:hover, body.wordpress #submit:hover, body.wordpress .button:hover, body.wordpress input[type="submit"]:focus, body.wordpress #submit:focus, body.wordpress .button:focus',
									  '.sidebar .widget:hover .widget-title' . ',' . '.sub-footer .widget:hover .widget-title, .footer .widget:hover .widget-title',
									  '.woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover',
									  '.slider-style2 .lSAction > a:hover',
									),
		...
		if ( !$hootpload ) {
			...
			array_push( $settings['accent_font']['color'], '.wordpress .button-widget.preset-accent', '.notice-widget.preset-accent', '.wordpress .button-widget.preset-accent:hover' );
		}
		$settings['headings_fontface_style'] = array(
